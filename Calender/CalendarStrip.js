 ...
 *
 */
const _iconLeft = require("./img/left-arrow-black.png");
const _iconRight = require("./img/right-arrow-black.png");
class CalendarStrip extends Component {
  ...
  static defaultProps = {
    ...
    showDate: true,
    updateWeek: true,
    iconLeft: Platform.OS=="web"?_iconLeft.default:_iconLeft,
    iconRight: Platform.OS=="web"?_iconRight.default:_iconRight,
