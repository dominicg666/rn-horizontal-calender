...
class CalendarDay extends Component {
  ...
  render() {
    ...
    if (customStyle) {
      ...
      _dateNumberContainerStyle.push(customStyle.highlightDateNumberContainerStyle);
      ...
      day = (
        ...
        >
          ...
          >
            {showDayName && (
              <Text
                style={[styles.weekStyle,{ fontSize: dateNameFontSize }, _dateNameStyle]}
            ...
            {showDayNumber && (
              <View style={[styles.dayContainer,_dateNumberContainerStyle]}>
                <Text
                  style={[
